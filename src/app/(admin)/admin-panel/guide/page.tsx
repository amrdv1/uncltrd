          ...
          <div className="text-zinc-600 dark:text-zinc-300">
            ...
            <div className="bg-zinc-50 dark:bg-[#151515] border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 mt-6">
              ...
              <ul className="text-sm font-medium space-y-3 text-zinc-600 dark:text-zinc-300 list-disc pl-5 marker:text-black dark:marker:text-white">
                ...
                <li><strong className="text-black dark:text-white">Конвертор GIF (Cloudinary):</strong> Якщо у вас є коротке відео (.mp4, .mov), яке ви хочете використати як "живу" обкладинку, перейдіть у вкладку <strong className="text-pink-500">GIF Конвертор</strong> в меню адмінки. Тепер він працює на базі потужної хмарної платформи Cloudinary, тому конвертація відбувається миттєво, а готові гіфки завантажуються блискавично по всьому світу.</li>
                ...
                <li><strong className="text-black dark:text-white">Прямі посилання з YouTube:</strong> Замість того, щоб шукати обкладинку кліпу вручну, ви можете просто вставити пряме посилання на відео з YouTube у поле "URL Обкладинки". Наша система автоматично спарсить і збереже найкращий кадр з цього відео у максимальній якості!</li>
              </ul>
            </div>
          </div>
        </section>
