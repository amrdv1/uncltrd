      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="flex items-center space-x-6 text-zinc-400">
            ...
            <Link href="https://www.instagram.com/uncultured.ua?igsh=aDR0ZjZveHczNzk4&utm_source=qr" target="_blank" rel="noopener noreferrer" className="hover:text-lime-400 transition-colors">
            ...
            <Link href="https://www.tiktok.com/@uncultured_media?_r=1&_t=ZN-97adGKSZIOI" target="_blank" rel="noopener noreferrer" className="hover:text-lime-400 transition-colors">
