...
export function MobileNavClient({ userRole, userName, userImage, isLoggedIn }: any) {
  ...
  return (
    <div className="lg:hidden">
      {/* Top Bar */}
      <div className="fixed top-0 left-0 w-full h-16 [.in-telegram_&]:h-[calc(4rem+var(--tg-safe-area-inset-top,0px))] [.in-telegram_&]:pt-[var(--tg-safe-area-inset-top,0px)] bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-zinc-200/50 dark:border-zinc-800/50 z-40 flex items-center justify-between px-6 shadow-sm transition-all">
      ...
      >
              <div className="flex items-center justify-between p-4 [.in-telegram_&]:pt-[calc(1rem+var(--tg-safe-area-inset-top,0px))] border-b border-zinc-200 dark:border-zinc-800">
