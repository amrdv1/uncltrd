            ...
            {link.subLinks ? (
              <div className="flex flex-col">
                <motion.button
                  ...
                  className="flex items-center justify-between w-full text-left text-2xl font-antapani font-normal uppercase tracking-tighter hover:text-accent transition-colors py-2 text-black dark:text-white"
                >
                  {link.label}
                  <motion.span
                    initial={false}
                        ...
                        <li key={subLink.label}>
                          ...
                          >
                            <motion.div 
                              ...
                              className="group flex items-center text-xl font-antapani font-normal uppercase tracking-tight text-zinc-500 dark:text-zinc-400 hover:text-accent transition-all"
                            >
              ...
              >
                <motion.div
                  whileTap={{ scale: 0.97, originX: 0 }}
                  className="group flex items-center text-2xl font-antapani font-normal uppercase tracking-tighter hover:text-accent transition-all py-2 text-black dark:text-white"
                >
                  <span className="transform transition-transform duration-300 ease-out group-hover:translate-x-3">
                    {link.label}
                  </span>
