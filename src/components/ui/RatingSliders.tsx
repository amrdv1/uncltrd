...
export function RatingSliders({ articleId, initialUserRating, totalScores, currentUserId, dynamicAdminTotal }: any) {
  ...
  return (
    <div className="bg-zinc-50 dark:bg-[#0a0a0a] rounded-2xl p-6 lg:p-10 border border-zinc-200 dark:border-zinc-800 shadow-2xl relative overflow-hidden transition-colors">
      {/* Background glow */}
