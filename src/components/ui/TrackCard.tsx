...
export function TrackCard({ 
  ...
  return (
    <Link href={`/article/${slug}`} className={cn("group flex flex-col w-full h-full bg-[#111] dark:bg-zinc-950 rounded-2xl transition-all duration-500 hover:bg-[#1a1a1a] dark:hover:bg-zinc-900 border border-white/5 hover:border-white/10 hover:shadow-2xl active:scale-[0.98]", compact ? "p-3" : "p-4", className)}>
      {/* Cover Image */}
